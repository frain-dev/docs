---
title: Convoy Version 0.9
sidebarTitle: v0.9 (latest)
description: "Convoy v0.9 was a major release from our previous versions. We officially switched from `MongoDB` to `PostgreSQL`. We integrated two Message Brokers to ingest webhook events. Please read on to learn more about what we shipped in this release."
---
## Release Highlights
