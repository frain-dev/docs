---
title: Convoy Version 0.7
sidebarTitle: v0.7
description: "We released Convoy v0.7 with new features, several bug fixes, UI enhancement, and performance improvements. Please take a look at the complete [changelog](https://getconvoy.io/docs/releases/version-7#changelog)."
---
## Release Highlights
