...
- Create multiple projects. Without a license, you can only have 2 projects. And if you already have more than 2, [here's](../business_and_enterprise/licensing#downgrades) what will happen in your instance.
- Add multiple users.
