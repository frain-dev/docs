...
a license key. Read [here](/business_and_enterprise/licensing) to learn about all the paid features, and [here](/business_and_enterprise/paid_features) to learn how to get a license key.
