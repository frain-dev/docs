...
This can be triggered from both the API -- [this endpoint](https://convoy.readme.io/reference/put_api-v1-projects-projectid-endpoints-endpointid-expire-secret) and the dashboard, see below: <Frame>![Expire Secret](/images/expire-secret.png)</Frame>
