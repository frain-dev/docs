...
community plan allows(2 projects), convoy will freeze all your projects except 2 from write operations e.g create event, create endpoint, create source etc.