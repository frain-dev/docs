...
'og:description': Convoy can be configured using CL Flags, Environment Variables or a configuration file.
'twitter:description': Convoy can be configured using CL Flags, Environment Variables or a configuration file.
...
```json Config
{
  ...
  // [optional]
  // you convoy license, you will to specify this in order to access paid features.
  ...
  "retention_policy": {
      ...
      // Specify whether the retention policy job should run.
      "enabled": false,
  }
  ...
  "storage_policy": {
    ...
    // The type can be either s3 or on_prem.
    "type": "s3",
